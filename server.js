...
// ============================================
// STORAGE UPLOAD ENDPOINTS (presigned URL approach)
// ============================================
// Files are uploaded directly from the client to Supabase Storage
// using presigned URLs generated by the server (service role key).
// This bypasses both Vercel's 4.5MB body limit and Supabase RLS.
